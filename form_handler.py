...
# -*- coding: utf-8 -*-
"""
🚀 UNIFEB BACKEND - QR CODE SUPPORT V3.5
✅ Cria chamados no SharePoint (V3 original FUNCIONANDO)
✅ Suporta 3 tipos: Manutenção, NAEM, TI
✅ Power Automate dispara emails automáticos
✅ Novo: Endpoint /api/chamados para Dashboard
✅ Novo: Campo Origem para diferenciar QRCode de Email
"""
...
def health():
    """Health check"""
    return jsonify({'status': 'ok', 'version': '3.5'}), 200
