...
# -*- coding: utf-8 -*-
"""
🚀 SINCRONIZADOR UNIFEB - PARA GITHUB ACTIONS
...
if not all([CLIENT_ID, CLIENT_SECRET, TENANT_ID]):
    ...
    print("Configure CLIENT_ID, CLIENT_SECRET, TENANT_ID nos GitHub Secrets")
    exit(1)
...
print("\n" + "="*80)
print("🚀 SINCRONIZADOR UNIFEB - GITHUB ACTIONS")
...
# ========== SALVAR JSON ==========
print(f"\n💾 Salvando {len(chamados)} chamado(s)...\n")
